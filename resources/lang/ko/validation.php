...
return [
    ...
    */
    ...
    'accepted_if' => ':attribute는 :other가 :value일 때 수락해야 합니다.',
    ...
    'alpha_dash' => ':attribute는 문자, 숫자, 대시 및 언더스코어만 포함할 수 있습니다.',
    ...
    'declined' => ':attribute를 거부해야 합니다.',
    'declined_if' => ':attribute는 :other가 :value일 때 거부해야 합니다.',
    'different' => ':attribute와 :other는 달라야 합니다.',
    'digits' => ':attribute는 :digits 자리 숫자여야 합니다.',
    'digits_between' => ':attribute는 :min과 :max 자리 숫자 사이여야 합니다.',
    ...
    'lt' => [
        ...
        'array' => ':attribute는 :value보다 적은 항목이 있어야 합니다.',
    ],
    'lte' => [
    ...
    'min' => [
        ...
        'string' => ':attribute는 최소 :min 문자 이상이어야 합니다.',
        'array' => ':attribute는 최소 :min 항목 이상이어야 합니다.',
    ],
    ...
    'prohibited_unless' => ':attribute 필드는 :other가 :values에 존재하지 않는 한 금지됩니다.',
    'prohibits' => ':attribute 필드는 :other의 존재를 금지합니다.',
    'regex' => ':attribute 형식이 유효하지 않습니다.',
    'required' => ':attribute 필드는 필수입니다.',
    'required_array_keys' => ':attribute 필드에 :values에 대한 항목이 포함되어야 합니다.',
    'required_if' => ':attribute 필드는 :other가 :value일 때 필수입니다.',
    'required_unless' => ':attribute 필드는 :other가 :values에 존재하지 않는 한 필수입니다.',
    'required_with' => ':attribute 필드는 :values가 존재할 때 필수입니다.',
    'required_with_all' => ':attribute 필드는 :values가 존재할 때 필수입니다.',
    'required_without' => ':attribute 필드는 :values가 존재하지 않을 때 필수입니다.',
    'required_without_all' => ':attribute 필드는 :values 중 어느 것도 존재하지 않을 때 필수입니다.',
    'same' => ':attribute와 :other는 일치해야 합니다.',
    'size' => [
        'numeric' => ':attribute는 :size 여야 합니다.',
